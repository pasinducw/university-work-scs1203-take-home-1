...
<div style="padding-top:20px;padding-bottom:30px">
    ...
    <p class="sesction1"><i class="fa fa-angle-double-right"></i>&nbsp;Create User</p>
    ...
    <table class="custom-table" id="emp-user-show-table">
        <thead>
            <tr>
                <th></th>
                <th>ID</th>
        ...
        <tbody>
            <tr>
                ...
                <td>Admin</td>
                <td>
                    <a href="" class="btn btn-sm btn-danger" role="button"><i class="fa fa-times"></i></a>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8">
                <br>
                <p class="sesction1"><i class="fa fa-angle-double-right"></i>&nbsp;Create Admin User</p>
                <form method="post" name="create-admin-user-form">
                    <div class="row">
                        <div class="col-md-8">
                            <div style="padding-bottom:10px">
                                <label class="mr-sm-2" for="select-user">User</label>
                                <select class="custom-select" oninput="selectInputUser(event)" id="select-user-for-create-admin" name="select-user-for-create-admin">
                        ...
                        <div class="col-md-4" style="padding-top:28px">
                            ...
                            <button type="submit" name="create-admin-user-form" class="btn btn-danger">Set as ADMIN User</button>
                        </div>
                    </div>
                </form>
                <br>
...
<script>
    ...
    function selectUser(event) {
        if (catCheckBoxCheck(event.target.className)) {
            ...
            document.getElementById('select-user-for-create-admin').value = event.target.value;
            document.getElementById('select-user-for-reset-password').value = event.target.value;

        } else {
            document.getElementById('select-user-for-create-admin').value = "";
    ...
    function selectInputUser(event) {
        ...
        if(event.target.id == "select-user-for-create-admin"){
            document.getElementById('select-user-for-reset-password').value = event.target.value;
        }else if(event.target.id == "select-user-for-reset-password"){
            document.getElementById('select-user-for-create-admin').value = event.target.value;
        }
    }
</script>
